...
namespace GuruTest
{
    ...
    partial void OnContentChanged();
		...
		[Association(Name="Article_Attachment", Storage="_Attachments", OtherKey="ArticleID")]
		...
		[Association(Name="Article_Comment", Storage="_Comments", OtherKey="ArticleID")]
		...
		[Association(Name="Account_Article", Storage="_Account", ThisKey="AuthorID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
    ...
    partial void OnAdministratorChanged();
		...
		[Association(Name="Role_AccountRole", Storage="_AccountRoles", OtherKey="Role")]
		...
		[Association(Name="Role_PermissionRole", Storage="_PermissionRoles", OtherKey="Role")]
    ...
    partial void OnFileIDChanged();
		...
		[Association(Name="Article_Attachment", Storage="_Article", ThisKey="ArticleID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		...
		[Association(Name="UserFile_Attachment", Storage="_UserFile", ThisKey="FileID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
    ...
    partial void OnContentChanged();
		...
		[Association(Name="Article_Comment", Storage="_Article", ThisKey="ArticleID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Article Article
		{
			get
			{
		...
		[Association(Name="Account_Comment", Storage="_Account", ThisKey="AuthorID", IsForeignKey=true)]
		public Account Account
		{
			get
			{
    ...
    partial void OnDisplayedNameChanged();
		...
		[Association(Name="UserFile_Attachment", Storage="_Attachments", OtherKey="FileID")]
		public EntitySet<Attachment> Attachments
		{
			get
			{
		...
		[Association(Name="Account_UserFile", Storage="_Account", ThisKey="OwnerID", IsForeignKey=true, DeleteRule="SET NULL")]
		public Account Account
		{
			get
			{
	...
	public partial class Account : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Data.Linq.Binary _PasswordAnswer;
		
		private bool _Locked;
		
		private System.Nullable<System.DateTime> _LockDateTime;
		
		private int _BadPasswordAttempts;
		
		private System.DateTime _BadPasswordWindowStart;
		
		private int _BadAnswerAttempts;
		
		private System.DateTime _BadAnswerWindowStart;
    ...
    partial void OnPasswordAnswerChanging(System.Data.Linq.Binary value);
    ...
    partial void OnBadPasswordAttemptsChanging(int value);
    partial void OnBadPasswordAttemptsChanged();
    partial void OnBadPasswordWindowStartChanging(System.DateTime value);
    partial void OnBadPasswordWindowStartChanged();
    partial void OnBadAnswerAttemptsChanging(int value);
    partial void OnBadAnswerAttemptsChanged();
    partial void OnBadAnswerWindowStartChanging(System.DateTime value);
    partial void OnBadAnswerWindowStartChanged();
    #endregion
		...
		[Column(Storage="_PasswordAnswer", DbType="Binary(16) NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		public System.Data.Linq.Binary PasswordAnswer
		{
			get
			{
		...
		[Column(Storage="_BadPasswordAttempts", DbType="Int NOT NULL")]
		public int BadPasswordAttempts
		{
			get
			{
				return this._BadPasswordAttempts;
			}
			set
			{
				if ((this._BadPasswordAttempts != value))
				{
					this.OnBadPasswordAttemptsChanging(value);
					this.SendPropertyChanging();
					this._BadPasswordAttempts = value;
					this.SendPropertyChanged("BadPasswordAttempts");
					this.OnBadPasswordAttemptsChanged();
				}
			}
		}
		
		[Column(Storage="_BadPasswordWindowStart", DbType="DateTime NOT NULL")]
		public System.DateTime BadPasswordWindowStart
		{
			get
			{
				return this._BadPasswordWindowStart;
			}
			set
			{
				if ((this._BadPasswordWindowStart != value))
				{
					this.OnBadPasswordWindowStartChanging(value);
					this.SendPropertyChanging();
					this._BadPasswordWindowStart = value;
					this.SendPropertyChanged("BadPasswordWindowStart");
					this.OnBadPasswordWindowStartChanged();
				}
			}
		}
		
		[Column(Storage="_BadAnswerAttempts", DbType="Int NOT NULL")]
		public int BadAnswerAttempts
		{
			get
			{
				return this._BadAnswerAttempts;
			}
			set
			{
				if ((this._BadAnswerAttempts != value))
				{
					this.OnBadAnswerAttemptsChanging(value);
					this.SendPropertyChanging();
					this._BadAnswerAttempts = value;
					this.SendPropertyChanged("BadAnswerAttempts");
					this.OnBadAnswerAttemptsChanged();
				}
			}
		}
		
		[Column(Storage="_BadAnswerWindowStart", DbType="DateTime NOT NULL")]
		public System.DateTime BadAnswerWindowStart
		{
			get
			{
				return this._BadAnswerWindowStart;
			}
			set
			{
				if ((this._BadAnswerWindowStart != value))
				{
					this.OnBadAnswerWindowStartChanging(value);
					this.SendPropertyChanging();
					this._BadAnswerWindowStart = value;
					this.SendPropertyChanged("BadAnswerWindowStart");
					this.OnBadAnswerWindowStartChanged();
				}
			}
		}
		
		[Association(Name="Account_Article", Storage="_Articles", OtherKey="AuthorID")]
		...
		[Association(Name="Account_Comment", Storage="_Comments", OtherKey="AuthorID")]
		public EntitySet<Comment> Comments
		{
			get
			{
		...
		[Association(Name="Account_UserFile", Storage="_UserFiles", OtherKey="OwnerID")]
		...
		[Association(Name="Account_AccountRole", Storage="_AccountRoles", OtherKey="Account")]
		public EntitySet<AccountRole> AccountRoles
		{
			get
			{
    ...
    partial void OnRoleChanged();
		...
		[Association(Name="Account_AccountRole", Storage="_Account1", ThisKey="Account", IsForeignKey=true)]
		...
		[Association(Name="Role_AccountRole", Storage="_Role1", ThisKey="Role", IsForeignKey=true)]
		public Role Role1
		{
			get
			{
    ...
    partial void OnNameChanged();
		...
		[Association(Name="Permission_PermissionRole", Storage="_PermissionRoles", OtherKey="Permission")]
		public EntitySet<PermissionRole> PermissionRoles
		{
			get
			{
    ...
    partial void OnRoleChanged();
		...
		[Association(Name="Permission_PermissionRole", Storage="_Permission1", ThisKey="Permission", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		...
		[Association(Name="Role_PermissionRole", Storage="_Role1", ThisKey="Role", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Role Role1
		{
			get
			{
